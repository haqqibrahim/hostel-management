...
const CREATE_INPUT = {
  adminEmployeeId: "exampleAdminEmployeeId",
  adminUniqueEmail: "exampleAdminUniqueEmail",
  adminUniqueName: "exampleAdminUniqueName",
  adminUniquePassword: "exampleAdminUniquePassword",
  createdAt: new Date(),
  id: "exampleId",
  updatedAt: new Date(),
};
