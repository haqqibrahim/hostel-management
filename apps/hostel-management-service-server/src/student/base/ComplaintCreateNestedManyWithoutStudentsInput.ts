...
@InputType()
class ComplaintCreateNestedManyWithoutStudentsInput {
...
export { ComplaintCreateNestedManyWithoutStudentsInput as ComplaintCreateNestedManyWithoutStudentsInput };
